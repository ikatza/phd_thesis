...
% % Modify parameters for positioning the floats
% \renewcommand{\topfraction}{0.7} %default: 0.7
% \renewcommand{\bottomfraction}{0.3} %default: 0.3
...
\captionsetup[subfigure]{labelfont=bf,list=true,listformat=simple}
\captionsetup[subtable]{labelfont=bf,list=true,listformat=simple}
